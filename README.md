...
|----------|--------|--------------|---------------------|----------------|-------|----------------|-----------------|
| [ts24.4.4](https://github.com/OpenCyphal/docker_toolchains/pkgs/container/toolshed) | <ul><li>3.12</li><li>3.10</li></ul> | <ul><li>13.3.0</li><li>12.3.0</li><li>11.4.0</li><li>10.5.0</li><li>7.5.0</li></ul>| 13.3.1 | <ul><li>19.1.7</li><li>18.1.8</li></ul> | 3.31.5 | <ul><li>linux/amd64</li><li>linux/arm64</li></ul> | <ul><li>JLink V816</li><li>cppcheck-2.13</li><li>yakut 0.13.0</li><li>libpcap0.8-dev</li><li>libzstd-dev</li><li>libmlir-19-dev</li><li>mlir-19-tools</li><li>network-tools</li><li>can-utils</li><li>doxygen 1.13.2</li><li>tox</li><li>nox</li><li>govr</li><li>lit</li><li>gcc-multilib (amd64 only)</li></ul> |
...
Starting with `ts24.4.4`, the image sets:
...
jobs:
  my-job:
    ...
    container: ghcr.io/opencyphal/toolshed:ts24.4.4
```
